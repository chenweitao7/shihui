...
$(function() {
    ...
    $.ajax({
        type: 'GET',
        url: 'http://193.112.8.16/shihui/ReturnCollectionAction',
        dataType: 'json',
        success: function(data) {
            console.log(data)
            $.each(data, function(index, json) {
                $('content ul').prepend("<li><div><img src='"+json['window_path']+"'></div><div class='ui-list-info ui-border-b'><h4 class='ui-nowrap'>"+json['window_name']+"</h4><h3 class='ui-nowrap'>aaa</h3><p class='ui-nowrap'>菜式：什么菜什么菜什么菜什么菜什么菜什么菜什么菜什么菜</p></div></li>");
            })
        },
